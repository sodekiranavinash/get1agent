...
handler = load_module("backend/services/knowledge-mcp/src/handler.py", "knowledge_mcp_handler")

from shared.dynamo.repositories import documents, knowledge_bases as kb, tags, users  # noqa: E402
from shared.ingestion.config import load_config  # noqa: E402
from shared.ingestion.pipeline import index_document  # noqa: E402
from shared.search.layout import chunks_key, embeddings_key  # noqa: E402
